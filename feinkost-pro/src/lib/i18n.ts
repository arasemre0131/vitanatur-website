...
export const translations = {
  ...
  "cart.title": { de: "Warenkorb", tr: "Sepet", en: "Shopping Cart" },
  ...
  "hero.subtitle": { de: "Handverlesene Delikatessen aus dem Orient", tr: "Doğu'dan özenle seçilmiş lezzetler", en: "Hand-selected gourmet foods from the Orient" },
  "hero.cta": { de: "Sortiment entdecken", tr: "Ürünleri keşfet", en: "Explore our selection" },
  ...
  "product.back_home": { de: "Zur Startseite", tr: "Ana sayfaya dön", en: "Back to homepage" },
  ...
  "cat.spezialitaeten": { de: "Spezialitäten", tr: "Özel Ürünler", en: "Specialities" },

  // Category descriptions
  "cat.gewuerze.desc": { de: "Handverlesene Gewürze aus dem Orient", tr: "Doğu'dan özenle seçilmiş baharatlar", en: "Hand-selected spices from the Orient" },
  ...
  "cat.fruehstueck.desc": { de: "Traditionelle Frühstücksspezialitäten", tr: "Geleneksel kahvaltılık lezzetler", en: "Traditional breakfast specialities" },
  ...
  "trust.quality": { de: "Handverlesene Qualität", tr: "Özenle seçilmiş kalite", en: "Hand-selected quality" },
  "trust.quality_desc": { de: "Jedes Produkt sorgfältig ausgewählt", tr: "Her ürün titizlikle seçildi", en: "Every product carefully curated" },
  ...
  "checkout.street": { de: "Straße und Hausnummer", tr: "Adres", en: "Street address" },
  ...
  "admin.stock": { de: "Bestand", tr: "Stok", en: "Inventory" },

  // Admin - Products
  "admin.products_title": { de: "Produkte", tr: "Ürünler", en: "Products" },
  "admin.products_count": { de: "Produkte im Sortiment", tr: "ürün mevcut", en: "products in stock" },
  ...
  "admin.drag_drop_sub": { de: "oder klicken zum Auswählen", tr: "veya seçmek için tıklayın", en: "or click to select" },
  ...
  "admin.status_update_error": { de: "Fehler beim Aktualisieren", tr: "Güncelleme hatası", en: "Update failed" },
  ...
  "notfound.home": { de: "Zur Startseite", tr: "Ana sayfaya dön", en: "Back to homepage" },
  ...
  "products.notfound.desc": { de: "In dieser Kategorie sind aktuell keine Produkte verfügbar. Schauen Sie bald wieder vorbei!", tr: "Bu kategoride şu an ürün bulunmamaktadır. Yakında tekrar kontrol edin!", en: "There are currently no products available in this category. Please check back soon!" },
  ...
  "admin.no_products_yet": { de: "Noch keine Produkte vorhanden.", tr: "Henüz ürün bulunmuyor.", en: "No products added yet." },
  ...
  "versand.intro": { de: "Wir liefern Ihre Bestellung schnell und sicher direkt zu Ihnen nach Hause.", tr: "Siparişlerinizi hızlı ve güvenli bir şekilde doğrudan kapınıza ulaştırıyoruz.", en: "We deliver your order quickly and securely right to your doorstep." },
  ...
  "versand.tracking_desc": { de: "Nach dem Versand erhalten Sie eine Tracking-Nummer per E-Mail, mit der Sie Ihre Sendung jederzeit verfolgen können.", tr: "Kargonuz gönderildikten sonra, gönderinizi takip edebileceğiniz bir takip numarası e-posta ile gönderilir.", en: "After dispatch, you will receive a tracking number by email so you can track your shipment at any time." },
  ...
  "faq.a4": { de: "Ja, alle Allergeninformationen finden Sie auf der jeweiligen Produktseite und auf der Verpackung jedes Produkts.", tr: "Evet, tüm alerjen bilgilerini ilgili ürün sayfasında ve her ürünün ambalajında bulabilirsiniz.", en: "Yes, all allergen information can be found on the respective product page and on the packaging of each product." },
  "faq.q5": { de: "Wie soll ich die Produkte lagern?", tr: "Ürünleri nasıl saklamalıyım?", en: "How should I store the products?" },
  "faq.a5": { de: "Unsere Trockenfrüchte und Nüsse sollten kühl und trocken gelagert werden. Öle am besten lichtgeschützt aufbewahren. Detaillierte Hinweise finden Sie auf der Produktverpackung.", tr: "Kuru meyve ve kuruyemişlerimiz serin ve kuru bir yerde saklanmalıdır. Yağları ışıktan korunarak muhafaza edin. Detaylı bilgileri ürün ambalajında bulabilirsiniz.", en: "Our dried fruits and nuts should be stored in a cool, dry place. Oils are best kept away from light. Detailed storage instructions can be found on the product packaging." },
  "faq.q6": { de: "Bieten Sie Großhandelspreise an?", tr: "Toptan satış fiyatları sunuyor musunuz?", en: "Do you offer wholesale pricing?" },
  "faq.a6": { de: "Ja, für Großbestellungen bieten wir Sonderkonditionen an. Bitte kontaktieren Sie uns über das Kontaktformular oder per E-Mail an hallo@feinkost.de.", tr: "Evet, toplu siparişler için özel fiyatlar sunuyoruz. Lütfen iletişim formumuz aracılığıyla veya hallo@feinkost.de adresine e-posta ile bize ulaşın.", en: "Yes, we offer special rates for bulk orders. Please contact us via the contact form or by email at hallo@feinkost.de." },
  ...
  "faq.a8": { de: "Unsere Produkte stammen aus dem gesamten Mittelmeerraum und dem Orient. Jedes Produkt wird sorgfältig ausgewählt und auf Qualität geprüft.", tr: "Ürünlerimiz Akdeniz ve Doğu bölgesinden gelmektedir. Her ürün özenle seçilir ve kalite kontrolünden geçirilir.", en: "Our products come from across the Mediterranean and the Orient. Every product is carefully selected and quality-tested." },
  // Coupons
  ...
  "coupon.error.max_uses": { de: "Gutschein wurde bereits zu oft verwendet", tr: "Kupon maksimum kullanım sayısına ulaştı", en: "Coupon has reached its maximum number of uses" },
  "coupon.generate": { de: "Code generieren", tr: "Kod Oluştur", en: "Generate Code" },
  "coupon.no_coupons": { de: "Keine Gutscheine vorhanden", tr: "Henüz kupon bulunmuyor", en: "No coupons available" },
  ...
  // Stock Management
  "stock.title": { de: "Bestandsverwaltung", tr: "Stok Yönetimi", en: "Inventory Management" },
  ...
  // Chat Widget
  "chat.title": { de: "Live Chat", tr: "Canlı Destek", en: "Live Chat" },
  "chat.welcome": { de: "Hallo! Wie können wir Ihnen helfen?", tr: "Merhaba! Size nasıl yardımcı olabiliriz?", en: "Hello! How can we help you?" },
  "chat.placeholder": { de: "Nachricht schreiben...", tr: "Mesajınızı yazın...", en: "Type a message..." },
  "chat.send": { de: "Senden", tr: "Gönder", en: "Send" },
  "chat.auto_reply": { de: "Ihre Nachricht wurde empfangen. Wir melden uns in Kürze bei Ihnen.", tr: "Mesajınız alındı. En kısa sürede size dönüş yapacağız.", en: "Your message has been received. We will get back to you shortly." },
  "chat.name_placeholder": { de: "Ihr Name (optional)", tr: "Adınız (opsiyonel)", en: "Your name (optional)" },
} as const;
