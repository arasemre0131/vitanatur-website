      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
        ...
        <div className="flex flex-col">
          ...
          <button
            ...
            className="mt-8 w-full sm:w-auto px-10 py-3.5 rounded-lg bg-olive-500 text-white font-medium text-base transition-colors hover:bg-olive-600 active:bg-olive-700 shadow-sm"
          >
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span
                className={`font-medium ${
                  product.inStock ? "text-olive-500" : "text-brick-500"
                }`}
              >
